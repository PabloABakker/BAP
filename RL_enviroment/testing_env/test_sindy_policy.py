...
def load_sindy_model(env_id):
    ...
    if not model_path.exists():
        ...
        fallback_path = Path(r"C:\Users\pablo\OneDrive\Bureaublad\Python\Machine learning\BAP_TOTAL\Bap_self\BAP\RL_enviroment\RL\sindy_policy.pkl")
...
def compare_trajectories(env_id="CartPole-v1", rl_algo="ppo", dt=0.001, render=False):
    ...
    # print("SINDy feature library input dimension:", sindy_model.feature_library.n_input_features)
